...
**深挖**：参考 `docs/03-plan/` 的 _index 和 template（暂无独立 skill）
...
**深挖**：参考 `docs/04-test-plan/` 的 _index 和 template（暂无独立 skill）
...
- Gate 4 → 参考 `docs/03-plan/`（暂无独立 skill）
- Gate 5 → 参考 `docs/04-test-plan/`（暂无独立 skill）
